        ...
        <div className="min-h-screen bg-metamask-beige">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8 flex gap-8">
                <aside className="hidden lg:block w-56 space-y-3">
                    ...
                    <Link href="/catalog" className="flex items-center gap-3 text-metamask-orange font-bold">
                        <Flame size={18} />
                        Trending
                    </Link>
                    <Link href="/catalog" className="flex items-center gap-3 text-metamask-purple/80 hover:text-metamask-purple font-bold transition-colors">
                        <Clock size={18} />
                        Latest
                    </Link>
                ...
                <main className="flex-1 space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                        <div>
                            ...
                            <h1 className="text-3xl md:text-4xl font-black text-metamask-purple tracking-tight">IPFS Video Feed</h1>
                        </div>
