...
"[project]/src/app/api/hashtags/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$turso$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`
        ...
        const sortedHashtags = Object.entries(hashtagCounts).map(([tag, count])=>({
                tag,
                count
            })).sort((a, b)=>b.count - a.count);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(sortedHashtags);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7913aabf._.js.map